"""
Description: Predicting BTC price for the next 3 months from the last 7 days (daily) market data.
Model: Multi-model.
Input: Last 3 hours of daily data of BTC price and 24-volume.
Output: Predicted BTC price in the next 3 months.
"""
...
# Constants
ASSET_PAIR = "BTC-USD"
MODEL_NAME = "08_btc_3m_from_btc_7d_multi"
MODEL_DESCRIPTION = "Predicting BTC price for the next 3 months from the last 7 days (daily) market data."
INPUT_DESCRIPTION = "Last 7 days of daily data of BTC price and 24-volume."
OUTPUT_DESCRIPTION = "Predicted BTC price in the next 3 months."

SOURCE_NAME = "data_cg_coins_market_chart_1d"
SOURCE_COLUMNS = ["Time", "Price", "24h_Volume"]

RETRAIN_INTERVAL = "1 hour"
N_TEST = 30 # Number of testing data points
LAGS = 7
...
mlflow.set_experiment("3 months BTC prediction")
