"""
Description: Predicting BTC price for the next 2 months from the last 8 hours (hourly) market data.
Model: Multi-model.
Input: Last 8 hours of hourly data of BTC price and 24-volume.
Output: Predicted BTC price in the next 2 months.
"""
...
# Constants
ASSET_PAIR = "BTC-USD"
MODEL_NAME = "07_btc_2m_from_btc_8h_multi"
...
OUTPUT_DESCRIPTION = "Predicted BTC price in the next two months."
