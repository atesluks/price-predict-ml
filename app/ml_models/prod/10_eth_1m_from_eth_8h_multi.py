"""
Description: Predicting ETH price for the next 1 month from the last 8 hours (hourly) market data.
Model: Multi-model.
Input: Last 8 hours of hourly data of ETH price and 24-volume.
Output: Predicted ETH price in the next month.
"""
...
# Constants
ASSET_PAIR = "ETH-USD"
MODEL_NAME = "10_eth_1m_from_eth_8h_multi"
MODEL_DESCRIPTION = "Predicting ETH price for the next 1 month from the last 8 hours (hourly) market data."
INPUT_DESCRIPTION = "Last 8 hours of hourly data of ETH price and 24-volume."
OUTPUT_DESCRIPTION = "Predicted ETH price in the next month."
...
mlflow.set_experiment("1 month ETH prediction")
