"""
Description: Predicting ETH price for the next 3 months from the last 7 days (daily) market data.
Model: Multi-model.
Input: Last 7 days of daily data of ETH price and 24-volume.
Output: Predicted ETH price in the next 3 months.
"""
...
# Constants
ASSET_PAIR = "ETH-USD"
MODEL_NAME = "12_eth_3m_from_eth_7d_multi"
MODEL_DESCRIPTION = "Predicting ETH price for the next 3 months from the last 7 days (daily) market data."
INPUT_DESCRIPTION = "Last 7 days of daily data of ETH price and 24-volume."
OUTPUT_DESCRIPTION = "Predicted ETH price in the next 3 months."

SOURCE_NAME = "data_cg_coins_market_chart_1d"
SOURCE_COLUMNS = ["Time", "Price", "24h_Volume"]

RETRAIN_INTERVAL = "3 hours"
N_TEST = 74 # Number of testing data points
LAGS = 7
...
DAYS_AHEAD_TO_PREDICT = 90

mlflow.set_tracking_uri(uri=os.getenv('MLFLOW_URL'))
mlflow.set_experiment("3 months ETH prediction")
