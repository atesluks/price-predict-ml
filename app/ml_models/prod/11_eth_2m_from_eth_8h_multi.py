"""
Description: Predicting ETH price for the next 2 months from the last 8 hours (hourly) market data.
Model: Multi-model.
Input: Last 8 hours of hourly data of ETH price and 24-volume.
Output: Predicted ETH price in the next 2 months.
"""
...
# Constants
ASSET_PAIR = "ETH-USD"
MODEL_NAME = "11_eth_2m_from_eth_8h_multi"
MODEL_DESCRIPTION = "Predicting ETH price for the next 2 months from the last 8 hours (hourly) market data."
INPUT_DESCRIPTION = "Last 8 hours of hourly data of ETH price and 24-volume."
OUTPUT_DESCRIPTION = "Predicted ETH price in the next 2 months."
...
mlflow.set_experiment("2 months ETH prediction")
